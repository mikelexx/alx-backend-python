...
def access_nested_map(nested_map: Mapping, path: Sequence) -> Any:
    ...
    for key in path:
        """
         referencing non dict e.g 'value' will raise other kinds of errors 
        e.g TypeError: string indices must be integers thus we make sure 
        we only to get dict specific error i.e KeyError always
        """
